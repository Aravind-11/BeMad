...
from tesseract import evaluation, metrics, mock, temporal


# from Tesseract.ml_release.tesseract import mock, temporal, evaluation, metrics

# sys.path.insert(0, r'C:\Users\ATHARVA\Documents\Atharva\Malware Detection IP\Tesseract\ml_release\tesseract')

# from tesseract import evaluation, metrics, temporal, mock

def main():
    # Generate dummy predictors, labels and timestamps from Gaussians
    X, y, t = mock.generate_binary_test_data(10000, '2022', '2024')
